...
static void createVertexBuffer()
{
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(Vector2f) * 100, &translations[0], GL_STATIC_DRAW);
    ...
    glBindBuffer(GL_ARRAY_BUFFER, instanceBuffer); // this attribute comes from a different vertex buffer
